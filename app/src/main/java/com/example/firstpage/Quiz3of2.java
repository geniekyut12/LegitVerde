...
public class Quiz3of2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz3of2);
        ...
        radioGroup.setOnCheckedChangeListener((group, checkedId) -> {
            if (checkedId != -1) { // Ensure a valid selection
                ...
                if (checkedId == R.id.btnq3of2B) { // Replace btnq2A with the actual button ID for question 2
                    score++; // Increment the score for the correct answer
                }

                // Proceed to the next question or finish quiz
                Intent intent = new Intent(Quiz3of2.this, Quiz4of2.class);

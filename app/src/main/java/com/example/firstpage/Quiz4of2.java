...
public class Quiz4of2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        radioGroup.setOnCheckedChangeListener((group, checkedId) -> {
            if (checkedId != -1) { // Ensure a valid selection
                ...
                if (checkedId == R.id.btnq4of2A) { // Replace btnq2A with the actual button ID for question 2
                    score++; // Increment the score for the correct answer
                }

                // Proceed to the next question or finish quiz
                Intent intent = new Intent(Quiz4of2.this, Quiz5of2.class);
